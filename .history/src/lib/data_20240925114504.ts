...
export const calendarEvents = [
  {
    ...
    allDay: false,
    start: new Date(2024, 9, 12, 14, 0), // October 12, 2024
    end: new Date(2024, 9, 12, 16, 0),
  },
  {
    title: "Networking Mixer",
    allDay: false,
    start: new Date(2024, 9, 15, 18, 0), // October 15, 2024
    end: new Date(2024, 9, 15, 21, 0),
  },
  {
    title: "Investor Pitch Day",
    allDay: true,
    start: new Date(2024, 9, 20), // October 20, 2024
    end: new Date(2024, 9, 20),
  },
  {
    title: "Startup Workshop: Legal Basics",
    allDay: false,
    start: new Date(2024, 9, 25, 10, 0), // October 25, 2024
    end: new Date(2024, 9, 25, 12, 0),
  },
  {
    title: "Tech Meetup",
    allDay: false,
    start: new Date(2024, 10, 5, 18, 30), // November 5, 2024
    end: new Date(2024, 10, 5, 20, 30),
  },
  {
  ...
  },
  {
    ...
    allDay: false,
    start: new Date(2024, 10, 22, 14, 0), // November 22, 2024
    end: new Date(2024, 10, 22, 15, 30),
  },
  {
    title: "Project Meeting",
    allDay: false,
    start: new Date(2024, 10, 25, 10, 0), // November 25, 2024
  ...
  },
  {
    ...
    allDay: false,
    start: new Date(2024, 11, 10, 13, 0), // December 10, 2024
    end: new Date(2024, 11, 10, 17, 0),
  },
  {
    title: "AI in Startups Seminar",
    allDay: false,
    start: new Date(2024, 11, 15, 9, 0), // December 15, 2024
    end: new Date(2024, 11, 15, 12, 0),
  },
  {
    title: "End-of-Year Startup Showcase",
    allDay: false,
    start: new Date(2024, 9, 24, 18, 0), // October 24, 2024
    end: new Date(2024, 9, 24, 22, 0),
  },
  {
    title: "New Year Kickoff Meeting",
    allDay: false,
    start: new Date(2024, 10, 5, 10, 0), // November 5, 2024
  ...
  },
  {
    ...
    allDay: true,
    start: new Date(2024, 10, 22), // November 22, 2024
    end: new Date(2024, 10, 26),
  },
  {
    title: "Market Research Presentation",
    allDay: false,
    start: new Date(2024, 9, 31, 14, 0), // October 31, 2024
    end: new Date(2024, 9, 31, 16, 0),
  },
];